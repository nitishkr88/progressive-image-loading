...
class ProgresiveImage extends PureComponent {
  static propTypes = {
    ...
    return (
      <div className="progressive-loading">
        <div className="progressive-loading-wrapper">
          ...
          <img src={placeholder} className={classNames('thumb', { blur, hide: ready })} />
        </div>
      </div>
    )
  }
...
export default withIntersectionObserver(ProgresiveImage)
